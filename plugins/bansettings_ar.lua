...
if is_banned(data.id_, arg.chat_id) then
   if not lang then
		...
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "_المستخدم_ "..user_name.." *[ "..data.id_.." ]* _تم الحضر_", 0, "md")
end
kick_user(data.id_, arg.chat_id)
end
if is_gbanned(data.id_) then
     if not lang then
		...
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "_المستخدم_ "..user_name.." *[ "..data.id_.." ]* _تم حضره حضر عام_", 0, "md")
   end
kick_user(data.id_, arg.chat_id)
     end
	end
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "*لا يمكن حضر المدراء والمشرفين والمطورين*", 0, "md")
         end
     end
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* * بالفعل محضور*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = user_name
   ...
   kick_user(data.id_, arg.chat_id)
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *تم الحضر*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *ليس محضور*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = nil
   ...
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *تم رفع الحضر عنه*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "*لا يمكن كتم المدراء والمشرفين والمطورين*", 0, "md")
       end
     end
...
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = user_name
  ...
  if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *تم اضافته لقائمة الكتم*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = nil
    ...
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *تم ازالة الكتم عنه*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if is_gbanned(data.id_) then
   if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *بالفعل محضور عام*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = user_name
   ...
   kick_user(data.id_, arg.chat_id)
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *تم حضره حضر عام*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not is_gbanned(data.id_) then
   if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *غير محضور حضر عام*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = nil
    ...
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *تم رفع الحضر العام منه*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*لا يمكن طرد المدراء والمشرفين والمطورين*", 0, "md")
   end
  else
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*لا يمكن حذف رسائل الادمنيه*", 0, "md")
   end
  else
tdcli.deleteMessagesFromUser(data.chat_id_, data.sender_user_id_, dl_cb, nil)
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_All_ *messages* _of_ *[ "..data.sender_user_id_.." ]* _has been_ *deleted*", 0, "md")
      elseif lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*جميع الرسائل* *[ "..data.sender_user_id_.." ]* *تم حذفها*", 0, "md")
       end
    end
  end
else
...
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = nil
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "*لا يمكن الحضر الا من قبل الادمنز*", 0, "md")
        end
     end
if is_gbanned(data.id_) then
   if not lang then
...
if not is_gbanned(data.id_) then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *غير محضور عام*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_المستخدم_ "..user_name.." *"..data.id_.."* *تم ازالة الحضر العام منه*", 0, "md")
   end
end
  if cmd == "kick" then
   if is_mod1(arg.chat_id, data.id_) then
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*لا يمكن طرد المدراء والمشرفين والمطورين*", 0, "md")
   end
  else
     kick_user(data.id_, arg.chat_id)
     end
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*لا يمكن حذف رسائل المدراء والمشرفين والمطورين*", 0, "md")
   end
  else
tdcli.deleteMessagesFromUser(arg.chat_id, data.id_, dl_cb, nil)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_All_ *messages* _of_ "..user_name.." *[ "..data.id_.." ]* _has been_ *deleted*", 0, "md")
      elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*جميع الرسائل* "..user_name.." *[ "..data.id_.." ]* *تم حذفها*", 0, "md")
       end
    end
  end
else
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   elseif lang then
     tdcli.sendMessage(msg.chat_id_, "", 0, "*لا يمكن طرد المدراء والمشرفين والادمنز*", 0, "md")
         end
     else
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "_You can't delete messages mods,owners or bot admins_", 0, "md")
     elseif lang then
   return tdcli.sendMessage(msg.chat_id_, "", 0, "*لا يمكن حذف رسائل المدراء والمشرفين والمطورين*", 0, "md")
   end
     else
tdcli.deleteMessagesFromUser(msg.chat_id_, matches[2], dl_cb, nil)
  ...
  return tdcli.sendMessage(msg.chat_id_, "", 0, "_All_ *messages* _of_ *[ "..matches[2].." ]* _has been_ *deleted*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(msg.chat_id_, "", 0, "*جميع رسائل* *[ "..matches[2].." ]* *تم حذفها*", 0, "md")
         end
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
    ...
    return tdcli.sendMessage(msg.chat_id_, "", 0, "*لا يمكن حضر الادمنز*", 0, "md")
        end
     end
  ...
  return tdcli.sendMessage(msg.chat_id_, "", 0, "*المستخدم "..matches[2].." بالفعل محضور حضر عام*", 0, "md")
        end
     end
...
kick_user(matches[2], msg.chat_id_)
 ...
 return tdcli.sendMessage(msg.chat_id_, msg.id_, 0, "*المستخدم "..matches[2].." تم حضره حضر عام*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "*المستخدم "..matches[2].." غير محضور حضر عام*", 0, "md")
        end
     end
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if is_mod1(msg.chat_id_, matches[2]) then
    ...
    return tdcli.sendMessage(msg.chat_id_, "", 0, "*لا يمكن حضر المدراء والمشرفين والمطورين*", 0, "md")
        end
     end
  ...
  return tdcli.sendMessage(msg.chat_id_, "", 0, "*المستخدم "..matches[2].." بالفعل محضور*", 0, "md")
        end
     end
...
kick_user(matches[2], msg.chat_id_)
 ...
 return tdcli.sendMessage(msg.chat_id_, msg.id_, 0, "*المستخدم "..matches[2].." تم الحضر والطرد*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
     tdcli_function ({
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "*المستخدم "..matches[2].." ليس محضور *", 0, "md")
        end
     end
...
return tdcli.sendMessage(msg.chat_id_, msg.id_, 0, "*المستخدم "..matches[2].." تم رفع الحضر عنه*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "*لا يمكن كتم المدراء والمشرفين والمطورين*", 0, "md")
        end
     end
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "*المستخدم "..matches[2].." بالفعل مكتوم*", 0, "md")
        end
     end
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = ""
 ...
 return tdcli.sendMessage(msg.chat_id_, msg.id_, 0, "*المستخدم "..matches[2].." تم كتمه*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if not is_silent_user(matches[2], chat) then
     ...
     return tdcli.sendMessage(msg.chat_id_, "", 0, "*المستخدم "..matches[2].." ليس مكتوم مسبقا*", 0, "md")
        end
     end
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = nil
 ...
 return tdcli.sendMessage(msg.chat_id_, msg.id_, 0, "*المستخدم "..matches[2].." تم ازالة الكتم *", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
     ...
     if not lang then
					...
					return "*لا يوجد مستخدمين محضورين بالمجموعه*"
              end
				end
     ...
     if not lang then
        ...
        if not lang then
					...
					return "*لا يوجد مستخدمين مكتومين بالمجموعه*"
             end
				end
       ...
       if not lang then
		...
		if matches[1]:lower() == 'حذف' and is_sudo(msg) then
			if matches[2] == 'gbans' then
				if next(data['gban_users']) == nil then
    if not lang then
					return "_No_ *globally banned* _users available_"
   else
					return "*لا يوجد مستخدمين محضورين عام*"
             end
				end
      ...
      if not lang then
				...
				return "*تم حذف قائمة المحضورين عام*"
          end
			end
     end
